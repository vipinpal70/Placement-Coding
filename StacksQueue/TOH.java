...
class TOH {
    ...
    void tohIterative(int num_of_disks, Stack src, Stack hepler, Stack dest) {
        ...
        for (i = 1; i <= total_num_of_moves; i++) {
            if (i % 3 == 1)
                ...
                moveDisksBetweenTwoPoles(src, hepler, s, a);

            else if (i % 3 == 0)
                moveDisksBetweenTwoPoles(hepler, dest, a, d);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        helper = ob.createStack(num_of_disks);

        ob.tohIterative(num_of_disks, src, helper, dest);
    }
}
